% "{'classe':('PSI'),'chapitre':'cin_point','type':('application'),'titre':'Guidage linéaire de systèmes médicaux', 'source':'Renan Bonnard','comp':(''),'corrige':False}"
...
\marginnote{Ressources de Renan Bonnard.}
%\marginnote[1cm]{
...
\begin{marginfigure}
\centering
\includegraphics[width=3cm]{Cy_12_Ch_04_Application_04_GlissiereBilles_qr}
\end{marginfigure}
\fi
